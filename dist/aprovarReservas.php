...
$query_reservas = "SELECT pk_reservas, titulo, espaços.nome, hr_ini, hr_fim, reservas.status, motivo, dt_hr_atualizacao, DATE_FORMAT(dt_ini, '%d/%m/%Y') as dt_ini, 
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text">Aprovar Reservas</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr align="center" class="odd gradeX">
                                                    ...
                                                    <td><?= $linha["dt_hr_atualizacao"] ?></td>
                                                    <td align="center">
                                                        <form action="updateReservaStatus.php" id="updateStatus" method="post">
                                                            <div class="btn-group">
                                                                ...
                                                                <button type="submit" class="btn btn-success btn-sm" id="deleteamc" name="pk_reservas" value="<?= $linha['pk_reservas'] ?>" data-toggle="tooltip" title="Confirma ou Cancela a reserva.">
